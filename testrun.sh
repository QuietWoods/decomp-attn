...
th train.lua -gpuid 1 -data_file data/entail-train.hdf5 -val_data_file data/entail-val.hdf5 -test_data_file data/entail-test.hdf5 -pre_word_vecs data/glove.hdf5 
 
# 处理测试数据
#bash predic_handle_test.sh data/atec_1.0_test.csv 

# 模型预测
th predict.lua -sent1_file sen1.txt -sent2_file sen2.txt -model model_final.t7 -word_dict data/entail.word.dict -label_dict data/entail.label.dict -output_file pred.txt
